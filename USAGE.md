...
| MS_TEAMS_NOTIFICATIONS_WEB_HOOK_URL          | Web hook url to send build failure notifications on Microsoft Teams (_available from v2.1.0_). It has been deprecated since _v5.0.0_ in favor of `MS_TEAMS_NOTIFICATIONS_WORKFLOW_URL`                                                                           |    no    |                        |                                 |
| MS_TEAMS_NOTIFICATIONS_WORKFLOW_URL          | MS Teams workflow url to send failure notifications on Microsoft Teams (_available from v5.0.0_)                                                                                                                                                                 |    no    |                        |                                 |
